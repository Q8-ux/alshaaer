...
| `MASAR_API_URL` | عند تفعيل بحث المصادر | عنوان HTTPS لنشر خدمة التحليل المعزولة. |
| `MASAR_ANT_ALSHAER_TOKEN` | عند تفعيل بحث المصادر | رمز المشروع الفريد داخل خدمة التحليل، 32 محرفًا على الأقل. |
